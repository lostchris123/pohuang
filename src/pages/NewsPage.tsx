...
const newsList = [
  {
    id: 0,
    title: '智慧检务新篇章 | 当正义遇见AI，我们这样开启未来',
    summary: '破荒AI走进宿州检察院，与一线检察同仁共探AI赋能检察工作的N种可能。已实现3秒完成千页卷宗关键信息提取、类案推送准确率突破92%、文书自动化生成节省60%人力，让算法为法律监督装上透视镜，用技术为公平正义铺设快车道。',
    date: '2025-04-30',
    tag: '行业应用',
  ...
  {
    id: 1,
    title: '破荒AI六大核心产品矩阵正式亮相',
    summary: '杭州破荒人工智能科技有限公司携爆款捕手、数字人平台、内容工厂、GEO优化、AI知识库平台、AI招投标系统六大核心产品，全方位展示AI技术在企业数字化转型中的创新应用成果。',
    date: '2026-04-25',
    tag: '展会动态',
  ...
  {
    id: 4,
    title: '破荒AI与多家行业知名企业达成战略合作',
    summary: '杭州破荒人工智能科技有限公司与多家行业知名企业签署战略合作协议，共同推进AI技术在多领域的深度应用与商业化落地。',
    date: '2026-04-10',
    tag: '合作动态',
